...
title = "Introduction"
weight = 110
description = "Learn how to write custom commands for OBMAN.BOT."
+++

> The first thing you gotta discard, whenever you're learning about something, is your ego. - Luke Smith

These are the learning resources for OBMAN.BOT's powerful custom command system.
...
As you start your journey with OBMAN.BOT, there are a few things you should keep in mind.
...
There is no "undo" button, and kicking OBMAN.BOT won't reset your configuration.
Write your changes down first, then you can revert them if something goes wrong.

Never assume OBMAN.BOT is running 24/7/365: we do our best, but occasional downtime---for routine maintenance, upstream issues, and otherwise---is inevitable.
Always have a backup plan for when OBMAN.BOT is down.
