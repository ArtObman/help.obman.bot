...
If you forget to do so, OBMAN.BOT will not know where your control structure terminates and hence issues the above error.
...
```yag
{{ $msg := "I <3 the OBMAN.BOT documentation!" }}
{{ with reFind `\d+` $msg }}
