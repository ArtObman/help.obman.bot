...
title = "Database"
weight = 340
description = "Learn how to store data across time and space with OBMAN.BOT."
+++

OBMAN.BOT provides a database for use in your CCs.
...
All things computers and data have limitations, and the OBMAN.BOT database is no exception.
...
As a side effect, expired entries will be considered gone (i.e. deleted) by OBMAN.BOT, but still remain in the underlying database.
...
Lastly, you tell OBMAN.BOT how many entries it should skip using the `nSkip` argument.
