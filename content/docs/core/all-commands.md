...
title = "All Commands"
weight = 240
description = "List of all available commands offered by OBMAN.BOT and their syntax."
+++

List of all available commands offered by OBMAN.BOT and their syntax.
...
Creates an embed from what you give it in JSON form: https://help.obman.bot/docs/refehttps://help.obman.bot/docs/reference/custom-embeds/#the-customembed-command
...
Shows OBMAN.BOT status, version, uptime, memory stats, and so on
