...
weight = 220
description = "View a list of recent changes to your OBMAN.BOT configuration."
+++

This page is the analogue of the audit log built in to Discord for OBMAN.BOT settings and summarizes recent edits on the control panel, listing the time, action, and responsible user for each.
