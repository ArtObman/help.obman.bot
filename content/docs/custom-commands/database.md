...
The ID is assigned by the system and unique within OBMAN.BOT's database.
...
OBMAN.BOT database entries have a max value size of 100 kB.
...
To search for any database entries whose Key contains `OBMAN.BOT`, use `%OBMAN.BOT%` as your search pattern.
