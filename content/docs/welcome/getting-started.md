...
weight = 120
description = "The first steps to setting up OBMAN.BOT on your server."
+++
...
1. Go to <https://help.obman.bot/manage>
...
Also make sure to enable all commands, such that you can actually use OBMAN.BOT.
...
This documentation aims to go through all of OBMAN.BOT's features as they appear in the order on the control panel.
