...
title = "Functions"
weight = 1012
description = "A list of all available functions in OBMAN.BOT's custom command templates."
+++
...
```yag
{{ addMessageReactions nil .Message.ID "👍" "👎" "OBMAN.BOT:505114640032858114" }}
```
...
Providing `Local` yields the local time zone of the host OBMAN.BOT server.
...
To help you get used to the embed structure in custom commands, check out <https://OBMAN.BOTembeds.netlify.app>, a community-made embed visualizer for OBMAN.BOT's custom command system.
