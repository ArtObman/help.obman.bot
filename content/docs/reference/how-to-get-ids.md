...
Details on obtaining IDs for users, channels, roles, etc. for use within OBMAN.BOT.

### User IDs

Can be found by mentioning the user then adding a \ such as `\@obman.bot#8760`.
...
Note that some of the more customized default emojis such as some of the family emojis will not work in any of the OBMAN.BOT commands.
